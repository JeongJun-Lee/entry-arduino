...
본 서는 최대한 쉽게 이해하실 수 있도록 간략화해 설명하고, 더 깊히 알고 싶은 분들을 위해서는 추가 정보를 제공하는 방식을 기술합니다. 따라서,  PIR 센서의 원리와 세팅방법, 연결 핀 배치에 대한 궁금하신 분들은 [부록](../appendix/pir_sensor.md)을 참고하세요. 

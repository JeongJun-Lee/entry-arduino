...
참고로 색 띠로 된 저항의 저항값 읽는 방법에 대해 궁금한 분이 있을텐데 링크로 드린 이전 참조 동영상에서 저항값 읽는 법도 설명하기 때문에 필요하지 않을 수도 있는데, 지면으로 한번 더 확인하고자 하시는 분들을 위해 별도의 [부록](../appendix/resistor_value.md)으로 남기니 참고하시기 바랍니다.
